...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='train_demo', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--data_path', type=str, default='./mvlrs_v1/main', help='where to load lrs2 train data')
        parser.add_argument('--data_path_valid', type=str, default='./mvlrs_v1/valid', help='where to load lrs2 train data')
        ...
        parser.add_argument('--style_feature_loss', action='store_true', help='to return middle')

        # for setting inputsf
        parser.add_argument('--dataset_mode', type=str, default='lrs2train')
        ...
        parser.add_argument('--z_dim', type=int, default=512, help='class label default 0')
        parser.add_argument('--c_dim', type=int, default=0, help='class label default 0')
        parser.add_argument('--w_dim', type=int, default=2560, help='class label default 0')
        parser.add_argument('--img_resolution', type=int, default=224, help='class label default 0')
        parser.add_argument('--img_channels', type=int, default=3, help='class label default 0')
